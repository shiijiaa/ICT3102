...
<!-- Side bar-->
	<?php include("php/sidebar/manageSideBar.php");?>
		...
		<?php include("php/Notification/ErrorSuccess.php");?>
			...
			<h1>Edit BlackSpot</h1>
			<hr>
 <form action="php/doEditBS.php"  method="post" style="padding:20px" class="spanx well" onsubmit="return validateForm(this)">
	<input type="hidden" name="user_id" value="<?php echo $user_id?>" />
	<input type="hidden" name="blackspot_id" value="<?php echo $bs_id?>" />
	...
	<div class="form-group">
	  ...
	  <input type="text"  name="location_address" class="form-control"  value="<?php echo $bs_add ?>">

	</div>
	<div class="form-group">
	  <label for="location_latitude" style="padding-bottom:8px;" tabindex="1">Latitude: </label>
	  <input type="number" step=0.00001 name="location_latitude" class="form-control" value="<?php echo $bs_lat ?>" >
	</div>
	
	<div class="form-group">
	  <label for="location_longtitude" style="padding-bottom:8px;" tabindex="1">Longtitude: </label>
	  <input type="number" step=0.0001 name="location_longtitude" class="form-control" value="<?php echo $bs_long ?>" >
	</div>	

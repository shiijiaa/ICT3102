...
<div class="container-fluid">
	...
	<?php include("php/sidebar/manageSideBar.php");?>
        ...
        <div class="col-xs-12 col-sm-9">
			...
			<h1>School Detail</h1>
			<hr>
			<p><b>School:</b> <?php echo $sch_name;?></p>
			<p><b>Education Level:</b> <?php echo $sch_edu ?></p>
			<p><b>Location Address:</b> <?php echo $sch_add ?></p>
			<p><b>Postal Code:</b> <?php echo $sch_postal ?></p>
			<p><b>Latitude:</b> <?php echo $sch_lat ?></p>
			<p><b>Longitude:</b> <?php echo $sch_long ?></p>
			<p><a href="aFeedback.php?sch_id=<?php echo $schID?>"><u>Read School Comment</u></a></p>
			<br>
			
			<a class="btn btn-primary btn-lg"  href="aManage.php">Back</a>
        </div>
        <!--/span-->

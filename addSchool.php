...
<!-- Side bar-->
 ...
 <form action="" method="post" style="padding:20px" class="spanx well" onsubmit="return validateForm(this)">
	...
	<div class="form-group required" >
        ...
        <select name="sch_educaiton_level" id="sch_educaiton_level" class="form-control" tabindex="2" >
		<option value="" disabled selected>Education Level</option>
		<?php 
		for($i=0;$i<count($eduLevelArr) ; $i++){
			$eduCate = strtoupper($eduLevelArr[$i]);
			$eduCateUpper = strtoupper($eduLevelArr[$i]);
			echo "<option value='$eduCateUpper'>$eduCate</option>";	
		}
		?>
        </select>
    </div>		
	...
	<div class="form-group">
	  ...
	  <input type="number" step=1 name="location_postalcode" class="form-control"  >
	</div>
